...
namespace BarberBooking.Server.Migrations
{
    ...
    [Migration("20250114223728_PasswordTokenColumnAddedInUserTable")]
    partial class PasswordTokenColumnAddedInUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarberBooking.Server.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BarberBooking.Server.Entities.User", b =>
                {
                    b.HasOne("BarberBooking.Server.Entities.Role", "Role")
                        .WithMany()
